...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        usstr = us.__str__()
        self.assertIn("[User] (234567)", usstr)
        self.assertIn("'id': '234567'", usstr)
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests to test the to_dict method of the User class."""
    ...
    def test_to_dict_contains_added_attributes(self):
        us = User()
        us.middle_name = "Grally"
        us.my_number = 98
        self.assertEqual("Grally", us.middle_name)
